...
xfconf-query -c xfce4-power-manager -p /xfce4-power-manager/lid-action-on-battery -s 1 --create # Suspend
xfconf-query -c xfce4-power-manager -p /xfce4-power-manager/lid-action-on-ac -s 1 --create # Suspend
xfconf-query -c xfce4-power-manager -p /xfce4-power-manager/critical-power-action -s 2 --create # Hibernate on low power
